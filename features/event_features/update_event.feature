...
Scenario: Update an event
  ...
  When I press "edit_club_event"
  Then I should be on the "Event Edit Page" for "Sample Event" in "HackBU"
  When I fill in "name" with "Sample Event 2.0"
  And I press "save_changes"
  Then I should be on the "Events Page" for "HackBU"
  And I should see "You successfully updated Sample Event 2.0"
